-- ticket-1: Comprehensive QC Validation for PortfolioInvestor Credit Reporting and Placement Upload
...
FROM BUSINESS_INTELLIGENCE_DEV.CRON_STORE.PORTFOLIO_INVESTOR_DEBT_SALE_Q1_2025_SALE_SELECTED;
...
SELECT 'Bulk Upload Placement File QC' as qc_check,
    ...
    COUNT(CASE WHEN 'DebtBuyer' = 'DebtBuyer' THEN 1 END) as records_with_resurgent_status,
...
SELECT 'Sample Placement Records' as qc_check,
    A.LOAN_ID as SYSTEM_LOAN_ID,
    UPPER(A.LEGACY_LOAN_ID) as loanid,
    B.SETTINGS_ID,
    'DebtBuyer' as Placement_Status,
