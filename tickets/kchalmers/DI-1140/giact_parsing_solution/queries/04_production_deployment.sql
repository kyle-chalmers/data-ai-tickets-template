-- =====================================================================
-- GIACT Data View Production Deployment Script
-- =====================================================================
-- Purpose: Deploy VW_OSCILAR_GIACT_DATA to production environments
-- Source: ARCA.FRESHSNOW.MVW_HM_Verification_Responses
-- Target: ARCA.FRESHSNOW → BUSINESS_INTELLIGENCE.BRIDGE → BUSINESS_INTELLIGENCE.ANALYTICS
-- =====================================================================

USE WAREHOUSE BUSINESS_INTELLIGENCE_LARGE;

DECLARE
    -- dev databases (uncomment for development deployment)
    -- v_de_db varchar default 'DEVELOPMENT';
    -- v_bi_db varchar default 'BUSINESS_INTELLIGENCE_DEV';
    
    -- prod databases (comment out for development deployment)
...
-- =====================================================================
-- FRESHSNOW SECTION - Primary View Creation
-- =====================================================================
    EXECUTE IMMEDIATE ('
        CREATE OR REPLACE VIEW ' || v_de_db || '.FRESHSNOW.VW_OSCILAR_GIACT_DATA(
...
-- =====================================================================
-- BRIDGE SECTION - Business Intelligence Layer
-- =====================================================================    
    EXECUTE IMMEDIATE ('
        CREATE OR REPLACE VIEW ' || v_bi_db || '.BRIDGE.VW_OSCILAR_GIACT_DATA(
            -- Application and customer identifiers
            APPLICATION_ID,
            BORROWER_ID,
            GIACT_INTEGRATION_NAME,
            ...
            SELECT * FROM ' || v_de_db ||'.FRESHSNOW.VW_OSCILAR_GIACT_DATA
    ');
    
-- =====================================================================
-- ANALYTICS SECTION - Analytics Layer
-- =====================================================================
    EXECUTE IMMEDIATE ('
        CREATE OR REPLACE VIEW ' || v_bi_db || '.ANALYTICS.VW_OSCILAR_GIACT_DATA(
            -- Application and customer identifiers
            APPLICATION_ID,
            BORROWER_ID,
            GIACT_INTEGRATION_NAME,
            ...
            SELECT * FROM ' || v_bi_db ||'.BRIDGE.VW_OSCILAR_GIACT_DATA
    ');
...
-- Verify FRESHSNOW deployment
SELECT 'FRESHSNOW deployed successfully' as status, COUNT(*) as record_count 
FROM ARCA.FRESHSNOW.VW_OSCILAR_GIACT_DATA;

-- Verify BRIDGE deployment
SELECT 'BRIDGE deployed successfully' as status, COUNT(*) as record_count 
FROM BUSINESS_INTELLIGENCE.BRIDGE.VW_OSCILAR_GIACT_DATA;

-- Verify ANALYTICS deployment
SELECT 'ANALYTICS deployed successfully' as status, COUNT(*) as record_count 
FROM BUSINESS_INTELLIGENCE.ANALYTICS.VW_OSCILAR_GIACT_DATA;
