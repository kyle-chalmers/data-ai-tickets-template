-- DI-1137: Massachusetts Regulator Request (LOAN TAPE VERSION)
...
-- Data Source: BUSINESS_INTELLIGENCE.DATA_STORE.MVW_LOAN_TAPE_MONTHLY
...
-- Main query for small dollar high rate loans using loan tape
...
WITH MA_SMALL_HIGH_RATE_SUMMARY AS (
    SELECT 
        LT.LOANID,
        LT.LOANAMOUNT,
        LT.ORIGINATIONDATE,
...
SELECT 
    'MA Loans ≤$6K with Rate >12% (LOAN TAPE)' AS QUERY_TYPE,
