/***********************************************************************************************************************
DI-1131 DEV Email View Deployment Script - ULTIMATE OPTIMIZED WITH UNIVERSAL APP DATES
Date: 2025-08-21
Author: Kyle Chalmers

Purpose: Deploy ultimate optimized lookup logic using universal APPLICATION_STARTED_DATE from BRIDGE.VW_LOS_CUSTOM_LOAN_SETTINGS_CURRENT
...
CREATE OR REPLACE VIEW BUSINESS_INTELLIGENCE_DEV.ANALYTICS_PII.VW_EMAIL_TO_PAYOFFUID_MATCH COPY GRANTS AS
