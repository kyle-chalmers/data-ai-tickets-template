/***********************************************************************************************************************
UPDATED DDL for BUSINESS_INTELLIGENCE.ANALYTICS_PII.VW_LEAD_PII
Date: 2025-08-18
Ticket: DI-1131
Changes: Added REGEXP_REPLACE to clean IN-MIGRATION- prefix from EMAIL fields in both CLS and LP sections
Purpose: Remove invalid "IN-MIGRATION-" prefix from email addresses at the source level
***********************************************************************************************************************/

CREATE OR REPLACE VIEW BUSINESS_INTELLIGENCE.ANALYTICS_PII.VW_LEAD_PII COMMENT='LoanPro Lead PII View - Updated with IN-MIGRATION email cleaning' AS
--CLS
SELECT LEAD_GUID,
       FIRST_NAME,
       LAST_NAME,
