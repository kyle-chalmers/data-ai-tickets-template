...
-- ANALYTICS section
    EXECUTE IMMEDIATE ('
        CREATE OR REPLACE VIEW ' || v_bi_db || '.ANALYTICS.VW_OSCILAR_PLAID_ASSET_REPORT_USERS COPY GRANTS AS 
            SELECT * FROM ' || v_bi_db ||'.BRIDGE.VW_OSCILAR_PLAID_ASSET_REPORT_USERS
    ');
