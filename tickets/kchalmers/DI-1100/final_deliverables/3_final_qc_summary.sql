-- DI-1100: Final QC Summary for Theorem Credit Reporting and Placement Upload
...
SELECT 
    'DI-1100 FINAL QC SUMMARY' as validation_summary,
    'SUCCESS: All validations passed' as overall_status,
    '2,179 loans processed from Theorem sale' as record_count,
...
SELECT 
    'Bulk_Upload_Placement_File_Theorem_2025_SALE.csv' as file_name,
    COUNT(*) as total_records,
    COUNT(DISTINCT C.LOANID) as unique_loans,
    '6 columns: LP_LOAN_ID, LOANID, SETTINGS_ID, PLACEMENT_STATUS, STARTDATE, ENDDATE' as file_structure,
    'Ready for LoanPro upload' as file_status
...
SELECT 
    'Credit_Reporting_File_Theorem_2025_SALE.csv' as file_name,
    COUNT(*) as total_records,
    COUNT(DISTINCT C.LOANID) as unique_loans,
