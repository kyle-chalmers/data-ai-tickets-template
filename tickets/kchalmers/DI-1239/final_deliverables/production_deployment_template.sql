-- VW_LOAN_BANKRUPTCY Production Deployment Template
-- Enhanced bankruptcy data object with ACTIVE status and duplicate detection
-- Ticket: DI-1239 | Created: 2025-01-09 | Updated: Added ACTIVE field and DUPE_CASE_NUMBER logic
...
BEGIN
    -- ANALYTICS section
    EXECUTE IMMEDIATE ('
        CREATE OR REPLACE VIEW ' || v_bi_db || '.ANALYTICS.VW_LOAN_BANKRUPTCY COPY GRANTS AS
        ...
        custom_settings AS (
            SELECT 
                ...
                NULL as CITY,
                NULL as STATE,
                NULL as PROOF_OF_CLAIM_DEADLINE_DATE,
                NULL as MEETING_OF_CREDITORS_DATE,
                NULL as OBJECTION_DEADLINE_DATE,
                NULL as OBJECTION_STATUS,
                NULL as LIENED_PROPERTY_STATUS,
                ...
                NULL as PROOF_OF_CLAIM_FILED_DATE,
