...
No FRESHSNOW or BRIDGE layer objects created - pure ANALYTICS layer view

Target: ANALYTICS layer only
Data Sources: Existing BUSINESS_INTELLIGENCE.BRIDGE and BUSINESS_INTELLIGENCE.ANALYTICS tables
*/

USE WAREHOUSE BUSINESS_INTELLIGENCE_LARGE;
USE ROLE BUSINESS_INTELLIGENCE_PII;

-- Deploy optimized fraud view directly to ANALYTICS layer
