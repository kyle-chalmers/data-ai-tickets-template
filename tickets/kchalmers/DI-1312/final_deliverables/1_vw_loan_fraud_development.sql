...
Purpose: Comprehensive fraud view combining custom fields, portfolios, and sub-statuses
Serves as suppression source for debt sales, fraud analysis, and data quality monitoring

Architecture: BRIDGE → ANALYTICS (2-layer deployment in BUSINESS_INTELLIGENCE)
Expected Records: 506 fraud loans
