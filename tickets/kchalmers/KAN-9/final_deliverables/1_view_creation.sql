-- ============================================================================
-- VIEW: VW_ORDER_ANALYTICS_MULTI_GRAIN
-- Purpose: Multi-grain analytics combining line-item detail with aggregations
-- Target Schema: ANALYTICS.DEVELOPMENT
-- Created: KAN-9
-- ============================================================================

CREATE OR REPLACE VIEW ANALYTICS.DEVELOPMENT.VW_ORDER_ANALYTICS_MULTI_GRAIN AS
...
-- Add comment
COMMENT ON VIEW ANALYTICS.DEVELOPMENT.VW_ORDER_ANALYTICS_MULTI_GRAIN IS
'Multi-grain order analytics: Line-item detail enriched with order, customer, and regional aggregations. Fulfilled orders only.';
