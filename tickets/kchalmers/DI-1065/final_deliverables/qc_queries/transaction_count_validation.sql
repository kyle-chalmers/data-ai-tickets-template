-- QC Query: Validate transaction counts in fortress Q2 2025 results
...
-- QC Summary
SELECT 
    'Q2 2025 Fortress Transaction Count Validation' as validation_check,
    COUNT(*) as total_rows,
    ...
    CASE 
        WHEN COUNT(*) = COUNT(DISTINCT TRANSACTION_ID) THEN 'PASS: No duplicates found'
        ELSE 'FAIL: Duplicate transactions detected'
