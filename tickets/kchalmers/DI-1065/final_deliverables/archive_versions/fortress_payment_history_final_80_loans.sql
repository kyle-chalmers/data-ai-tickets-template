-- DI-1065: Fortress Quarterly Due Diligence Payment History - ALL 80 LOANS CORRECTED
...
-- CORRECTED: 75 loans from Attachment B + 5 loans from Attachment C = 80 total
