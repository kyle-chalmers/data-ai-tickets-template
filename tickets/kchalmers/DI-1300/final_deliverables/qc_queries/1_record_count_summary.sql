-- DI-1300 QC: Record Count Summary
...
-- QC Summary
SELECT '1. Genesys Phone Calls' AS data_source,
...
SELECT '2. Genesys SMS' AS data_source,
       COUNT(*) AS record_count,
       COUNT(DISTINCT tpl.lead_guid) AS unique_loans,
       MIN(a.INTERACTION_START_TIME) AS earliest_interaction,
       MAX(a.INTERACTION_START_TIME) AS latest_interaction
...
SELECT '3. Genesys Email' AS data_source,
       COUNT(*) AS record_count,
       COUNT(DISTINCT tpl.lead_guid) AS unique_loans,
       MIN(a.INTERACTION_START_TIME) AS earliest_interaction,
       MAX(a.INTERACTION_START_TIME) AS latest_interaction
...
SELECT '5. SFMC Email' AS data_source,
       COUNT(*) AS record_count,
