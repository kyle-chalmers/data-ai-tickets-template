...
-- BRIDGE LAYER: Complete transformation dynamic table (all business logic here)
    ...
    RETURN 'Production deployment complete. Dynamic table created: ' || v_bi_db || '.BRIDGE.LOANPRO_APP_SYSTEM_NOTES with DOWNSTREAM refresh.';

END;

-- USAGE INSTRUCTIONS:
-- 1. Production Deployment: Run this entire script to create dynamic table
...
ALTER DYNAMIC TABLE BUSINESS_INTELLIGENCE.BRIDGE.LOANPRO_APP_SYSTEM_NOTES REFRESH;
*/
...
SHOW DYNAMIC TABLES LIKE '%LOANPRO_APP_SYSTEM_NOTES%' IN BUSINESS_INTELLIGENCE.BRIDGE;
*/