-- DI-974: DEV VERSION - OPTIMIZED ALTER VW_DSH_MONTHLY_ROLL_RATE_MONITORING View to Add SIMM Placement Flag
-- Performance optimizations while maintaining identical business logic
-- DEPLOYED TO: BUSINESS_INTELLIGENCE_DEV.REPORTING (Development Testing)

CREATE OR REPLACE VIEW BUSINESS_INTELLIGENCE.REPORTING.VW_DSH_MONTHLY_ROLL_RATE_MONITORING AS
