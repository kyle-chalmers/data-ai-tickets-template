-- =============================================================================
-- United States: Top 5 Years with Highest Temperature Change
-- Temperature change in degrees Celsius vs 1951-1980 baseline
-- Uses efficient CROSS JOIN UNNEST approach
-- =============================================================================
...
-- =============================================================================
-- | Rank | Year | Temperature Change (°C) |
-- |------|------|-------------------------|
-- | 1    | 2022 | +2.216                  |
-- | 2    | 2021 | +1.533                  |
-- | 3    | 2018 | +1.458                  |
